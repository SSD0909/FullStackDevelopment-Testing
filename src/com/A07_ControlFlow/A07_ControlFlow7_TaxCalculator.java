...
public class A07_ControlFlow7_TaxCalculator {
...
System.out.println("Welcome to The U.S. federal personal income tax Calculator");
...
case 1 :{
	...
	if(taxableIncome<=8350) {
		...
		System.out.printf("The total Payable tax for the Household Income is : $%6.2f%n",taxamount);
		System.out.printf("The total Income after tax is : $%6.4f",incomeTax);
		...
		double taxamount=taxableIncome*taxRate;
		double incomeTax=taxableIncome-taxamount;
		System.out.printf("The total Payable tax for the Household Income is : $%6.2f",taxamount);
		System.out.printf("The total Income after tax is : $%6.4f",incomeTax);
	}

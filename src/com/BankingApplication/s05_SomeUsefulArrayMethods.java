...
//8b and 8b... next checks if a given item is contained within
import java.util.Scanner;

// a menu driven program to test a selection of useful array methods 

public class s05_SomeUsefulArrayMethods
{
	public static void main (String[] args)
	{
		...
		//8b... next checks if a given item is contained within the a
	...
	//8a... next checks if a given item is contained within the array
